...
** DONE generating thumbnail file names
   SCHEDULED: <2014-04-27 So>
** TODO support for (mostly) arbitrary hierarchical structure [0%]
*** TODO subgalleries
...
**** TODO provide web interface requirements [0%]
***** TODO breadcrumbs
***** TODO thumbnails
...
* Tasks
** TODO disallow gallery name "data"
   [2014-08-22 Fr 12:14]
   [[file:~/Projekte/simple-image-gallery/web-ui.lisp::(defpar%20image-data-url-regex%20"/simple-gallery/data/(%5B^/%5D%2B)/(%5B^/%5D%2B)/(%5B^/%5D%2B)\\.(%5B^/.%5D%2B)")][file:~/Projekte/simple-image-gallery/web-ui.lisp::(defpar image-data-url-regex "/simple-gallery/data/([^/]+)/([^/]+)/([^/]+)\\.([^/.]+)")]]
